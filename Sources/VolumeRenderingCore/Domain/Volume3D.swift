...
//  MetalVolumetrics
//
//  Defines the basic domain entities representing a renderable 3D volume.
//  These types mirror the legacy Isis DICOM Viewer domain models so adapters
//  and presentation layers can collaborate without depending on the app
//  target directly.
//
